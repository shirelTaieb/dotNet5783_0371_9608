...
public class Program //main program
{
    ...
    {
        IDal? dalist = Dal.DalList.Instance;
        ...
        while (num != 0)
        {
            ...
            switch (num)// 3 option: 1 2 or 3
            {
                case 1:
                    ...
                    break;
                case 2:
                    testOrderItem(dalist.OrderItem);// they want an operation on the order item
                    break;
                case 3:
                    testProduct(dalist.Product);// they want an operation on the product
                    break;
                default:
                    break;
            }
    ...
    private static void testOrder(IOrder order)//all the operation on order
    {
        try
        {
    ...
    private static void testOrderItem(IOrderItem item)
    {
        try
        {
    ...
    private static void testProduct(IProduct product)
    {
        try
        {
            ...
            switch (option)
            {
                case "a":
                    ...
                    {
                        case 0:
                            tmpProduct.Category = Category.Children;
                            break;
                        case 1:
                            tmpProduct.Category = Category.Holy;
                            break;
                        case 2:
                            tmpProduct.Category = Category.Theoretical;
                            break;
                        case 3:
                            tmpProduct.Category = Category.History;
                            break;
                        case 4:
                            tmpProduct.Category = Category.Romans;
                            break;
                        default:
                ...
                case "d":
                    ...
                    {
                        case 0:
                            tmpProduct2.Category = Category.Children;
                            break;
                        case 1:
                            tmpProduct2.Category = Category.Holy;
                            break;
                        case 2:
                            tmpProduct2.Category = Category.Theoretical;
                            break;
                        case 3:
                            tmpProduct2.Category = Category.History;
                            break;
                        case 4:
                            tmpProduct2.Category = Category.Romans;
                            break;
                        default:
                            Console.WriteLine("ERROR");
                            break;
